...
namespace ImGuiNET
{
    class Program
    {
        ...
        static System.Collections.Generic.List<System.Drawing.Bitmap> bitmaps = new System.Collections.Generic.List<System.Drawing.Bitmap>();
            ...
            while (_window.Exists)
            {
                ...
                if (bitmaps.Count > 0)
                {
                    ...
                    using (var ms = new System.IO.MemoryStream())
                    {
                        ...
                        var img = new Veldrid.ImageSharp.ImageSharpTexture(ms);
                        texPrt = GetOrCreateTexture(img);
                    }
                    bitmaps.RemoveAt(0);
                }
                if (texPrt!=IntPtr.Zero)
                {
                    ImGui.Image(texPrt,new Vector2(1280,720));
                }
        ...
        private static IntPtr GetOrCreateTexture(Veldrid.ImageSharp.ImageSharpTexture img)
        {
        ...
        private static unsafe void DecodeAllFramesToImages(AVHWDeviceType HWDevice,Action<System.Drawing.Bitmap> onbitmap)
        {
                ...
                using (var vsd = new VideoStreamDecoder(url, HWDevice))
                {
                        ...
                        new VideoFrameConverter(sourceSize, sourcePixelFormat, destinationSize, destinationPixelFormat))
                    {
                        ...
                        while (vsd.TryDecodeNextFrame(out var frame))
                        {
                            ...
                            var bitmap = new System.Drawing.Bitmap(convertedFrame.width,
                            ...
                            //    //    var img = new Veldrid.ImageSharp.ImageSharpTexture(ms);
                            //    //}
                            //    //bitmap.Save($"frame.{frameNumber:D8}.jpg", );
                            //}
